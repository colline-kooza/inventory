...
export default function AdjustmentComponent({warehouse , itemsData}) {
...
{
  activeForm ==="add" ?(<AddInventoryForm itemsData={itemsData} warehouse={warehouse}/>):(<TransferInventory warehouse={warehouse}/>)
}
    </div>
  )
}
