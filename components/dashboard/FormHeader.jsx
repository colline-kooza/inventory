...
export default function FormHeader({title}) {
  return (
    <div id="marketing-banner" tabIndex="-1" className="z-50 flex md:flex-row justify-between w-[calc(100%-2rem)] lg:p-4 p-2 mt-2 ml-2 rounded-lg lg:shadow-sm lg:max-w-7xl dark:bg-white dark:border-gray-600">
