    ...
    <h2 className="font-medium mb-2">Upload {label}</h2>
     {
      imageUrl?(
        <button
        className="text-white inline-flex gap-2 items-center bg-black hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center  dark:hover:bg-blue-700 dark:focus:ring-blue-800"
         onClick={() => setImageUrl('')}
       >
